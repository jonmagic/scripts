...
5. Install unreviewed builds into an isolated VS Code Insiders profile or extension directory for smoke checks. Do not overwrite @jonmagic's daily-driver extension install unless explicitly asked.
...
4. Handoff names changed files and any remaining risks.
